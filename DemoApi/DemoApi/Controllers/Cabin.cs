...
public class Cabin
{
    ...
    DataTable dt;
    Check chk = new Check();
    public DataTable bindroomddl2(string pakackageid, int departureId)
    {
        chk.name = "rajib";
        chk.surname = "sarkar";
    ...
    public DataTable bindroomddl(string pakackageid, int departureId, int accomid)
    {
        chk.name = "rajib";
        chk.surname = "sarkar";
        ...
        try
        {
            ...
            //        Console.Write("Error");
            //}
            blsr.action = "GetcruiseRoomsApi";
            blsr.PackageId = pakackageid;
            blsr.DepartureId = departureId;
            blsr.accomId = accomid;
            //blsr._iAgentId = usercode;
            dt = new DataTable();
            dt = dlsr.GetCruiseRooms(blsr);
            if (dt != null)
